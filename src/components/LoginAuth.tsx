...
export default function LoginAuth(){
    return (
        <form className="flex flex-col gap-5 mb-10">
            ...
            <Input id="email" text="******@email.com" type="email" label="Email Address" className=""/>
            

            <div className="relative">
                <Input id="email" text="••••••••" type="password" label="Password" className="w-full"/>
